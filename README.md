...
```javascript
doublyLinkedList = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-doubly-linked-list@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/utils-doubly-linked-list/tags). For example,

```javascript
doublyLinkedList = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-doubly-linked-list@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var doublyLinkedList = require( 'path/to/vendor/umd/utils-doubly-linked-list/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-doubly-linked-list@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/utils-doubly-linked-list/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/utils-doubly-linked-list/actions/workflows/test.yml?query=branch:v0.2.2
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/utils-doubly-linked-list.svg
[dependencies-url]: https://david-dm.org/stdlib-js/utils-doubly-linked-list/main
...
[deno-readme]: https://github.com/stdlib-js/utils-doubly-linked-list/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/utils-doubly-linked-list/tree/umd
[umd-readme]: https://github.com/stdlib-js/utils-doubly-linked-list/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/utils-doubly-linked-list/tree/esm
[esm-readme]: https://github.com/stdlib-js/utils-doubly-linked-list/blob/esm/README.md
...
[@stdlib/utils/linked-list]: https://github.com/stdlib-js/utils-linked-list/tree/umd
